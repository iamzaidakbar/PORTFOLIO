                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="Responsible for the design and implementation of user interfaces (UIs) and UI components using React, a front-end JavaScript library. I develop and maintain UIs for web and mobile apps."
                            data={[
                                "HTML",
                                "CSS",
                                "SCSS",
                        ...
                        <Service
                            num="3"
                            title="Gamer ( Multiplayer )"
                            desc="Conquered top E-Sport games in my career with 10+ years of experience such as Valorant, Counter-Strike: Global Offensive, Battlegrounds Mobile India, Call of Duty Series, FIFA, Tom Clancy's Rainbow Six Siege. BGMI: Ranked in the top 100 players of last year’s tournament."
                            data={[
                                "Strategizing",
                                "Leadership",
                                "Teamwork",
