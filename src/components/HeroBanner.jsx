			...
			<Wrapper>
				...
				>
					...
					<div className="max-w-[510px]">
						Professionally, I specialize in creating user interfaces that are intuitive and visually appealing. I work with
						latest front-end technologies such as, React-Js to build responsive websites and web applications that are accessible
						to all users.
					</div>
				</motion.div>
				{/* INTRO END */}
